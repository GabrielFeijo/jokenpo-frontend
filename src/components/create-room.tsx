...
const CreateRoom = ({
	...
	setGameMode: React.Dispatch<React.SetStateAction<'CLASSIC' | 'EXTENDED'>>;
			...
			>
				...
				<div className="space-y-6">
					...
					>
						...
						<input
							...
							className="w-full rounded-xl border-2 border-white/20 bg-black/20 p-4 text-white placeholder-white/50 backdrop-blur-sm transition-all duration-300 hover:border-white/40 focus:border-blue-400 focus:outline-none focus:ring-4 focus:ring-blue-400/20"
							maxLength={20}
						/>
					</motion.div>
					...
					>
						...
						<div className="grid grid-cols-2 gap-3">
							<motion.button
								...
								className={`relative overflow-hidden rounded-xl p-4 font-semibold transition-all duration-300 ${
									gameMode === 'CLASSIC'
										? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-2xl shadow-blue-500/30'
										: 'border-2 border-white/20 bg-black/20 text-white hover:bg-white/10'
								} `}
							>
								{gameMode === 'CLASSIC' && (
						...
						<motion.p
							className="my-3 rounded-lg bg-white/5 p-3 text-center text-xs text-white/60"
							initial={{ opacity: 0 }}
							animate={{ opacity: 1 }}
				...
				>
					...
					<motion.button
						...
						className="relative flex-1 overflow-hidden rounded-xl border-2 border-white/20 bg-gradient-to-r from-yellow-500 to-orange-600 p-4 font-bold text-white shadow-2xl transition-all duration-300 hover:from-yellow-600 hover:to-orange-700 disabled:cursor-not-allowed disabled:opacity-50"
					>
