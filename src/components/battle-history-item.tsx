...
const BattleHistoryItem = ({ match, index }: { match: Match; index: number }) => {
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center space-x-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="text-xs text-white/40 flex items-center space-x-2 bg-white/5 px-2 py-1 rounded-lg w-fit">
                            <Calendar size={12} />
